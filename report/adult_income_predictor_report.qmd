...
@fig-eda1 notes that the population with the highest count of >50K earners are married under civil law.

![Income Level by Relationship Status](../results/figures/eda2.png){#fig-eda2 width=75%}

@fig-eda2 notes that the population with the highest count of >50K earners play a role as husband in their relationships.

![Income Level by Occupation](../results/figures/eda3.png){#fig-eda3 width=75%}

@fig-eda3 notes that the population with the highest count of >50K earners have executive or managerial positions in their occupations or have a specialty in their professional field.

![Income Level by Workclass](../results/figures/eda4.png){#fig-eda4 width=75%}

@fig-eda4 notes that the population with the highest count of >50K earners are in the provate sector.

![Income Level by Race](../results/figures/eda5.png){#fig-eda5 width=75%}

@fig-eda5 notes that the population with the highest count of >50K earners are primarily white.

![Income Level by Sex](../results/figures/eda6.png){#fig-eda6 width=75%}

@fig-eda6 notes that the population with the highest count of >50K earners are primarily male.
