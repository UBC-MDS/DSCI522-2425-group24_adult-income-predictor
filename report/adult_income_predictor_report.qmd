...
Note: The process to create the plots above was inspired by (Ostblom, J. INSERT REFERENCE)
...
The test score was 0.7842.

![Confusion Matrix](../results/figures/cm.png){#fig-cm width=75%}

The process followed for creating the model was inspired by (Kolhatkar, V INSERT REFERENCE) and (Pedregosa, F., Varoquaux, G., Gramfort, A., Michel, V., Thirion, B., Grisel, O., et al INSERT REFERENCE)
...
REMOVE THE FOLLOWING LINES ONCE THE REFERENCES ARE SET AND CALLED FROM MARKDOWN
